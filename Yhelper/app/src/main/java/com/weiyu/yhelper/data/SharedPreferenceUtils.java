...
public class SharedPreferenceUtils {
    ...
    public SharedPreferenceUtils(Context context, String filename, int mode){
     ...
     * 单例模式
     * */
    public SharedPreferenceUtils getInstance(Context context,String filename,int mode){
        if (utils == null) {
            utils = new SharedPreferenceUtils(context,filename,mode);
        } return utils;
    }
