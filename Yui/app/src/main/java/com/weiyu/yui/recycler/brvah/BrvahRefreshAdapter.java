...
public class BrvahRefreshAdapter extends BaseQuickAdapter implements BaseQuickAdapter.RequestLoadMoreListener {
    private Context context;
    private List<String> data;
    public BrvahRefreshAdapter(int layoutResId, @Nullable List<String> data,Context context) {
